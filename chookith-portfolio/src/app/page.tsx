      ...
      <main>
        ...
        <section className="m-10 flex h-auto w-auto flex-col items-center justify-center text-center">
          ...
          <ul className="row-auto grid w-full grid-cols-1 flex-col items-center justify-center gap-5 lg:grid-cols-3">
            <li className="flex w-full animate-[dropIn_1200ms_ease_500ms_backwards] flex-col items-center justify-center rounded-3xl bg-sunlightyellow p-5 shadow-md transition delay-75 hover:-translate-y-1 hover:shadow-xl">
              <Link
            ...
            <li className="flex w-full animate-[dropIn_1200ms_ease_550ms_backwards] items-center justify-center rounded-3xl bg-sunlightyellow p-5 shadow-md transition delay-75 hover:-translate-y-1 hover:shadow-xl">
              <Link
            ...
            <li className="flex  w-full animate-[dropIn_1200ms_ease_600ms_backwards]  items-center justify-center rounded-3xl bg-sunlightyellow p-5 shadow-md transition delay-75 hover:-translate-y-1 hover:shadow-xl">
              <Link
            ...
            <li className=" flex  w-full animate-[dropIn_1200ms_ease_700ms_backwards] flex-col items-center justify-center rounded-3xl bg-cream p-5 shadow-md transition delay-75 hover:-translate-y-1 hover:shadow-xl ">
          ...
          <ul className="row-auto grid w-full grid-cols-1 flex-col items-center justify-center gap-5 lg:grid-cols-3">
            <li className="flex w-full animate-[dropIn_1200ms_ease_850ms_backwards] flex-col items-center justify-center rounded-3xl bg-summergreen p-5 shadow-md transition delay-75 hover:-translate-y-1 hover:shadow-xl">
            ...
            <li className=" 3 flex w-full animate-[dropIn_1200ms_ease_900ms_backwards] flex-col items-center justify-center rounded-3xl bg-summergreen p-5 shadow-md transition delay-75 hover:-translate-y-1 hover:shadow-xl">
              {" "}
