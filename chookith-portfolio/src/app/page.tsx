      ...
      <main>
        <section className="flex w-auto flex-col md:flex-row xl:h-screen">
          <section className="flex flex-col items-center justify-center md:ml-10 md:mt-16 md:basis-1/2 lg:mt-32 xl:h-auto">
            <h1 className="mt-5 animate-dropIn items-center justify-center text-center text-4xl sm:mt-10 sm:text-5xl ">
              {" "}
              I am
            </h1>
        ...
        <section className="mx-10 flex h-auto w-auto flex-col">
          <h1 className="mt-24 animate-[dropIn_1300ms_ease_600ms_backwards] pb-10 text-center text-5xl md:pl-5">
            About Me
          </h1>
          <div className="flex animate-[dropIn_1300ms_ease_700ms_backwards] flex-row items-center justify-center divide-none lg:divide-x lg:divide-solid">
            <article className="hidden flex-col items-center justify-center lg:flex lg:basis-1/2 ">
              <q className="hidden">
            ...
            <article className="mx-10 lg:basis-1/2 lg:pl-12">
        ...
        <section className="h-auto w-auto pb-36">
          <article className="mt-24 pb-10 text-center">
            ...
            <ul className="mx-10 flex flex-col items-center justify-center">
              <h2 className="my-5 flex animate-[dropIn_1200ms_ease_800ms_backwards] items-center justify-center text-3xl">
                Completed
              </h2>
              <section
                id="themes"
              ...
              >
                <li className="mt-5 flex w-full animate-[dropIn_1300ms_ease_900ms_backwards] flex-col items-center justify-center rounded-3xl bg-sunlightyellow p-5 shadow-xl transition delay-75 hover:-translate-y-1 lg:mx-5 lg:basis-1/3">
                  <Link
                ...
                <li className="mt-5 flex h-auto w-full animate-[dropIn_1300ms_ease_900ms_backwards] flex-col items-center justify-center rounded-3xl bg-sunlightyellow p-5 shadow-xl transition delay-75 hover:-translate-y-1 lg:mx-5  lg:basis-1/3">
                  <Link
              ...
              >
                <li className="flex w-full basis-1/3 lg:mx-5"></li>
                <li className=" flex  w-full animate-[dropIn_1300ms_ease_900ms_backwards] flex-col items-center justify-center rounded-3xl bg-cream p-5 shadow-xl transition delay-75 hover:-translate-y-1 lg:mx-5 lg:w-auto lg:basis-1/3">
              ...
              <h2 className="mt-5 flex animate-[dropIn_1200ms_ease_800ms_backwards] items-center justify-center text-3xl">
                In Progress
              </h2>
              <section
                id="Line 2"
              ...
              >
                <li className="flex w-full basis-1/3 lg:mx-5"></li>
                <li className="mt-10 flex w-full animate-[dropIn_1300ms_ease_900ms_backwards] flex-col items-center justify-center rounded-3xl bg-summergreen p-5 shadow-xl transition delay-75 hover:-translate-y-1 lg:mx-5 lg:w-auto lg:basis-1/3">
        ...
        <section className=" h-full w-full rounded-2xl bg-ashblue px-16 py-12 shadow-xl ">
          <h1 className="mt-5 animate-[dropIn_1300ms_ease_600ms_backwards] pb-10 text-center text-5xl lg:mt-5 lg:pl-5">
